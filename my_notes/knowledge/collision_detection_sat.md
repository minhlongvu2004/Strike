...
- [1. Polygon](#1-polygon)
- [2. Separating axis theorem](#2-separating-axis-theorem)
- [3. Projection with dot product](#3-projection-with-dot-product)
- [4. General algorithm](#4-general-algorithm)
- [5. Example of triangle and rectangle](#5-example-of-triangle-and-rectangle)
  - [5.1 No collision](#51-no-collision)
  - [5.2 Collision](#52-collision)
...
# 5 Example of triangle and rectangle
